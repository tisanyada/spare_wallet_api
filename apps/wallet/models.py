...
class Wallet(TimeStampedUUIDModel):
    ...
    # wallet_number = models.CharField(max_length=255, default=wallet_card_id_generator(), unique=True)
    wallet_balance = models.CharField(max_length=255, blank=True, null=True)
    wallet_user = models.ForeignKey(User, related_name="wallet_user", blank=True, null=True, on_delete=models.DO_NOTHING)
...
class DebitCard(TimeStampedUUIDModel):
    ...
    # card_number = models.CharField(max_length=255, default=wallet_card_id_generator(), unique=True)
    card_type = models.CharField(max_length=255, blank=True, null=True)
    card_expiration = models.DateField(blank=True, null=True)
    card_user = models.ForeignKey(User, related_name="card_user", blank=True, null=True, on_delete=models.DO_NOTHING)
